...
class AppStrings {
  ...
  String get settingsNotifications => _get({'ko': '알림', 'en': 'Notifications', 'ja': '通知', 'zh': '通知'});
  String get settingsNotificationTime => _get({'ko': '알림 시간', 'en': 'Notification Time', 'ja': '通知時刻', 'zh': '通知时间'});
  ...
  String get settingsBackup => _get({'ko': '백업 및 복원', 'en': 'Backup & Restore', 'ja': 'バックアップと復元', 'zh': '备份和恢复'});
