...
class DailyPlan extends DataClass implements Insertable<DailyPlan> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || recipients != null) {
  ...
  DailyPlansCompanion toCompanion(bool nullToAbsent) {
    return DailyPlansCompanion(
      ...
      recipients: recipients == null && nullToAbsent
          ? const Value.absent()
          : Value(recipients),
    );
  }
  ...
  DailyPlan copyWith(
      ...
      DailyPlan(
        ...
        recipients: recipients.present ? recipients.value : this.recipients,
      );
  ...
  @override
  int get hashCode => Object.hash(id, date, content, type, goalCount,
      isGenerated, isCompleted, sortOrder, recipients);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DailyPlan &&
...
class $$DailyPlansTableFilterComposer
  ...
  ColumnFilters<int> get goalCount => $composableBuilder(
      column: $table.goalCount, builder: (column) => ColumnFilters(column));
...
class $$DailyPlansTableOrderingComposer
  ...
  ColumnOrderings<int> get goalCount => $composableBuilder(
      column: $table.goalCount, builder: (column) => ColumnOrderings(column));
